...
public class PATH {
    ...
    /**
     * 类加载时，此变量就被确定
     * 类加载时，以相对路径寻找"out\\production\\HDQS\\Launcher.class"
     * 和"Launcher.class"，并以此为基准判断运行环境
    ...
    static {
        File runInIDEA = new File("out\\production\\HDQS\\Launcher.class");
        File runInCmd = new File("Launcher.class");
        if (runInIDEA.exists()) {
