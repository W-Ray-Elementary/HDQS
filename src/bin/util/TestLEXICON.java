...
public class TestLEXICON {
    public static void main(String[] args) {
        ...
        System.out.println("bin.util.LEXICON 的测试成功完成于" + ' ' + cost + ' ' + "ms");
    }
    ...
    public static void BenchMark() {
        ...
        long startTime = System.currentTimeMillis();
        benchmark = LEXICON.getInstance(benchmark.toString());
        long cost = System.currentTimeMillis() - startTime;
        System.out.println("bin.util 的基准测试成功完成于" + ' ' + cost + ' ' + "ms");
    }
    ...
    private static void TEST_LEXICON() {
        ...
        if (blankLexicon.lineCount() != 3)
            throw new RuntimeException("类 bin.util.LEXICON 在空白返回了错误的文本行数量，" +
        ...
        if (textLexicon.lineCount() != 7)
            throw new RuntimeException("类 bin.util.LEXICON 在纯文本返回了错误的文本行数量，" +
        ...
        if (nestLexicon.lineCount() != 13)
            throw new RuntimeException("类 bin.util.LEXICON 在嵌套返回了错误的文本行数量，" +
        ...
        LEXICON infiniteLexicon = new LEXICON("INFINITE");
        {
            ...
            if (!pass) {
                throw new RuntimeException("类 bin.util.LEXICON 在自指时不抛异常");
            }
        }
        ...
        LEXICON mk1pod_v2 = LEXICON.getInstance(PATH.getFile(testFilePath));
        ...
        // 测试模糊查询
        LEXICON fuzzyLexicon = LEXICON.getInstance(PATH.getFile("testRes\\util\\fuzzyLexicon.cfg"));
        ...
        LEXICON removal = LEXICON.getInstance(textLexicon.toString());
        removal.remove("员工");
