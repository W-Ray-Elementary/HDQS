...
:: SmartIO.jar
javac -classpath "out\batchBuild\HDQS\lib\Lexicon.jar;src\main\java" -d "out\batchBuild\temp" -encoding UTF-8 "src\main\java\com\plzEnterCompanyName\HDQS\io\smartIO2\Message.java"
javac -classpath "out\batchBuild\HDQS\lib\Lexicon.jar;src\main\java" -d "out\batchBuild\temp" -encoding UTF-8 "src\main\java\com\plzEnterCompanyName\HDQS\io\smartIO2\MessageManager.java"
